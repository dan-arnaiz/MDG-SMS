...
export default function EditEmployeeContacts() {
    ...
    useEffect(() => {
        ...
        if (barangays2.length > 0) handleBarangayChange(barangay2,'mailing')
    ...
    const LoadEmployee = () => {
        ...
        .then((request) => {
            ...
            reset({
                ...
                addressSimilarity: request.data.permanentAddress.addressSimilarity
            });

            setAddressSimilarity(request.data.permanentAddress.addressSimilarity);
